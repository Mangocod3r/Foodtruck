    ...
    <footer className="footer-footer">
          <div className="footer-container">
            <div className="footer-container1">
              <span className="footer-text">Khiran's Food Truck</span>
              <span>Copyright © 2023 Khiran's Food Truck.</span>
            </div>
          ...
          <img alt="image" src="./playground_assets/waves-white.svg" className="footer-image" />
        </footer>
  )
}
